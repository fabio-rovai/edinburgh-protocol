...
//!
//! External MCP servers communicate via newline-delimited JSON-RPC 2.0 over
//! stdin/stdout. This module provides the transport layer: serialise a request,
//! write it to the child's stdin, read the response from stdout, and deserialise it.
//!
